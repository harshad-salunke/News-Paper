...
class NewsApp:
	...
	def __init__(self, root):
		...
		#========title frame===========#
		bg_color = "gray"
		text_area_bg = "sky blue"
		basic_font_color = "gray2"
		title = Label(self.root, text="NewsPaper", font=("times new roman", 30, "bold"),
		...
		#Adding voice Button
		b2=Button(news_title,text="Voice ",width=5,font="arial 15 bold" ,bg="red")
		b2.place(x=1160,y=85)
		...
		try:
			...
			if(articles != 0):
				for i in range(len(articles)):
					new_title=articles[i]['title']
					new_dis=articles[i]['description']
					self.txtarea.insert(END, f"{i+1} : {new_title}\n")
					self.txtarea.insert(
						END, f"{new_dis}\n\n")
